...
#         self.depthwise_conv = nn.Conv2d(n_channels, n_channels, kernel_size=7, stride=1, padding=3))
...
if __name__ == "__main__":
    model = convnext_tiny(in_chans=1)
    x = torch.randn(32, 1, 64, 44)
    print(model(x).shape)
    print(count_parameters(model))

"""
torch.Size([32, 96, 16, 11])    torch.Size([32, 96, 16, 11])
torch.Size([32, 192, 8, 5])     torch.Size([32, 192, 8, 5])
torch.Size([32, 384, 4, 2])     torch.Size([32, 384, 4, 2])
torch.Size([32, 768, 2, 1])     torch.Size([32, 768, 2, 1])
FWD torch.Size([32, 768])
HEAD torch.Size([32, 1000])
torch.Size([32, 1000])
"""
